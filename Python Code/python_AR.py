                ...
                for i in ar_list:
                    ...
                    if i[0] == list_pebble[1]:
                        if vari.id_list[list_pebble[1]] == 0 :
                            gl = pather_NO_6_TEX_2.gl_list #green
                             ...
                             gl = pather_NO_5_TEX_2.gl_list
                        overlay(frame, ar_list, i[0],gl)
                    if i[0] == list_pebble[2]:
                        if vari.id_list[list_pebble[2]] == 0 :
                            gl = pather_NO_6_TEX_3.gl_list  #blue
                        elif vari.id_list[list_pebble[2]]== 1:
                            gl = pather_NO_5_TEX_3.gl_list
                        overlay(frame, ar_list, i[0],gl)
                    if i[0] == mtemp:
                    ...
                    if i[0] == 10:
                        ...
                        if vari.C_variable ==-2 :
                            ...
                            elif  vari.C_variable == local_list[2]:
                                cr =Crow4.gl_list #blue
